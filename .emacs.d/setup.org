...
#+BEGIN_SRC emacs-lisp
  (customize-set-variable
   ...
   '(benchmark-init
     ...
     projectile magit undo-tree browse-kill-ring ripgrep
...
#+BEGIN_SRC emacs-lisp
  ...
  (cset 'web-mode-markup-indent-offset 2)
...
| q       | quoted-insert                        | fill-paragraph                                               | ~swiper-all~                                                 |
...
| y       | yank                                 | ~counsel-yank-pop~ +yank-pop+                                | ~browse-kill-ring~                                           |
...
* todo
- list projectile commands
- decide whether to keep vimish-fold
- rethink ivy swiper counsel bindings
