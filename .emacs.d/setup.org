...
#+BEGIN_SRC emacs-lisp
  ...
  (bind-keys :map smartparens-mode-map
             ...
             ("M-d"     . sp-kill-word)
             ("M-n"     . sp-forward-parallel-sexp)
             ("M-p"     . sp-backward-parallel-sexp))
...
| [       | [ESC-]                 |                 | ~sp-backward-slurp-sexp~          |                                | ~sp-backward-barf-sexp~           |                           |
| ]       | abort-recursive-edit   |                 | ~sp-forward-slurp-sexp~           |                                | ~sp-forward-barf-sexp~            |                           |
| ;       | []                     |                 | comment-dwim                      |                                | [M-;]                             |                           |
...
| b       | backward-char          |                 | backward-word                     |                                | ~sp-backward-down-sexp~           | +backward-sexp+           |
...
| f       | forward-char           |                 | forward-word                      |                                | ~sp-up-sexp~                      | +forward-sexp+            |
| g       | keyboard-quit          |                 | [M-g-]                            |                                | []                                |                           |
...
| j       | newline-and-indent     |                 | indent-new-comment-line           |                                |                                   | +indent-new-comment-line+ |
...
| n       | next-line              |                 | ~sp-forward-parallel-sexp~        |                                | ~sp-down-sexp~                    | +forward-list+            |
| o       | open-line              |                 | [M-o-]                            |                                | split-line                        |                           |
| p       | previous-line          |                 | ~sp-backward-parallel-sexp~       |                                | ~sp-backward-up-sexp~             | +backward-list+           |
